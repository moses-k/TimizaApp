...
public class Settings extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSeleted(MenuItem item){
        int id = item.getItemId();
        if(id == R.id.nav_myaccout){
            Intent searchIntent = new Intent(Settings.this, My_account.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
        }else if(id == R.id.nav_notifications){
            Intent searchIntent = new Intent(Settings.this, Notification.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
            ...
            Intent searchIntent = new Intent(Settings.this, Locate_us.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
        }else if(id == R.id.nav_about) {
            Intent searchIntent = new Intent(Settings.this, About.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
        }else if(id == R.id.nav_logout) {
            Intent searchIntent = new Intent(Settings.this, Logout.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
        }
