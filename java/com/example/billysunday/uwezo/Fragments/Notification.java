...
public class Notification extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSeleted(MenuItem item){
        ...
        if(id == R.id.nav_myaccout){
            Intent searchIntent = new Intent(Notification.this, My_account.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
        }else if(id == R.id.nav_notifications){
            Intent searchIntent = new Intent(Notification.this,Notification.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
        }else if(id == R.id.nav_settings){
            Intent searchIntent = new Intent(Notification.this, Settings.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
        }else if(id == R.id.nav_locate) {
            Intent searchIntent = new Intent(Notification.this, Locate_us.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
        }else if(id == R.id.nav_about) {
            Intent searchIntent = new Intent(Notification.this, About.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
        }else if(id == R.id.nav_logout) {
            Intent searchIntent = new Intent(Notification.this, Logout.class);
            startActivity(searchIntent);
            overridePendingTransition(R.anim.pull_in_right, R.anim.push_out_left);
        }
